...
export default function RegisterPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(extractApiError(registerError, "Unable to create account."));
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <main style={pageStyle}>
      ...
      <div style={cardStyle}>
        ...
        <h1 style={titleStyle}>Start monitoring with the current backend flow</h1>
        <p style={subtitleStyle}>
          Registration now sends the backend’s expected JSON body with `email`, `password`, `name`, and `company`.
        </p>
...
const ambientOrbOne: React.CSSProperties = {
  ...
  height: 420,
  borderRadius: "50%",
  background: "radial-gradient(circle, rgba(91,74,247,0.48), rgba(91,74,247,0))",
  top: -120,
  right: -80,
  filter: "blur(60px)",
};
